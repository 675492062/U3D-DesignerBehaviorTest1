...
//	public bool Snap()
//	{
//		UISpriteData sData = mAtlas.GetSprite(mSpriteName);
//		if(sData != null && sData.width>0 && sData.height>0)
//		{
//			int sWidth = sData.width;
//			int sHeight = sData.height;
//			
//			if(sWidth%2>0.0f) sWidth = sWidth + 1;
//			if(sHeight%2>0.0f) sHeight = sHeight + 1;
//			
//			SetDimensions(sWidth,sHeight);
//			return true;
//		}
//		return false;
//	}
